...
public class UserManagementController {
	...
	@PostMapping("/login")
	public ResponseEntity<UserDTO> login(@RequestBody UserLoginRequestDTO loginRequest) {
    ...
    public ResponseEntity<?> performLogout(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        // Create a cookie with the same name as the session cookie but with a Max-Age of 0
